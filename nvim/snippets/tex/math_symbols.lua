...
return {
  ...
  autosnippet({ trig = ";h", name = "Greek eta" }, t "\\eta", { condition = tsutils.in_mathzone }),
  autosnippet(
  ...
  autosnippet({ trig = ";p", name = "Greek pi" }, t "\\pi", { condition = tsutils.in_mathzone }),
  ...
  autosnippet({ trig = ";f", name = "Greek phi" }, t "\\phi", { condition = tsutils.in_mathzone }),
