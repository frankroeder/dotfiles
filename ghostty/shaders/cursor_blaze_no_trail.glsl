...
// const vec4 TRAIL_COLOR = vec4(0.533, 0.224, 0.93, 1.0); // Mauve
// const vec4 TRAIL_COLOR_ACCENT = vec4(0.447, 0.529, 0.992, 1.0); // Lavender

const vec4 TRAIL_COLOR= vec4(0.447, 0.529, 0.992, 1.0); // Lavender
const vec4 TRAIL_COLOR_ACCENT = vec4(0.533, 0.224, 0.93, 1.0); // Mauve
