...
export FZF_CTRL_T_OPTS="--no-mouse --preview 'file {}' --preview-window
  down:1:hidden:wrap --bind '?:toggle-preview'"

export FZF_CTRL_R_OPTS="--no-mouse --preview 'echo {}' --preview-window
