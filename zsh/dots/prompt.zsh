...
zstyle :prompt:pure:git:branch color "${DANK_TERM_FOREGROUND:-#151c24}"
zstyle :prompt:pure:git:branch:cached color "${DANK_TERM_RED:-#91002e}"
zstyle :prompt:pure:git:dirty color "${DANK_TERM_YELLOW:-#b7ac00}"
zstyle :prompt:pure:git:action color "${DANK_TERM_YELLOW:-#b7ac00}"
...
zstyle :prompt:pure:execution_time color "${DANK_TERM_YELLOW:-#b7ac00}"
